	...
	\cventry
	  ...
	  {2022 - Present} % Date(s)
	  {
		\begin{cvitems} % Description(s) of tasks/responsibilities
		  \item {Setup Deep Packet Inspection and Flow based monitoring for the entire campus network using ntopng + Elasticsearch, which was used to identify and mitigate various security threats and bandwidth hogs}
